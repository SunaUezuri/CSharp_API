...
namespace Aula.Cliente.API.Controllers
{
    ...
    public class AulaController : ControllerBase
    {
        ...
        [SwaggerResponse(200, "Os dados da aula retornaram com sucesso", typeof(List<AulaModel>))]
        [SwaggerResponse(StatusCodes.Status204NoContent, "Nenhum dado foi encontrado")]
